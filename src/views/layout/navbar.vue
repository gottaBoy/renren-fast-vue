  ...
  <nav class="site-navbar" :class="navbarClasses">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">Sting41 System</a>
        <a class="site-navbar__brand-mini" href="javascript:;">41</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-menu-item index="2">
          <el-badge value="hot">
            <a href="//www.gottaboy.cn/" target="_blank">官方社区</a>
          </el-badge>
        </el-menu-item>
        <el-submenu index="3">
          <template slot="title">Git源码</template>
          <el-menu-item index="2-1"><a href="//www.gottaboy.cn" target="_blank">前端</a></el-menu-item>
          <el-menu-item index="2-2"><a href="//www.gottaboy.cn" target="_blank">后台</a></el-menu-item>
          <el-menu-item index="2-3"><a href="//www.gottaboy.cn" target="_blank">代码生成器</a></el-menu-item>
        </el-submenu>
